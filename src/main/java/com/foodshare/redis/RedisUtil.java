...
public final class RedisUtil {
     ...
     *
     * @param key   键
     * @param maxCount 移除多少个
     * @param value 值
     * @return 移除的个数
     */
    public long lRemove(String key, long maxCount, Object value) {
        try {
            Long count = redisTemplate.opsForList().remove(key, maxCount, value);
            return count == null ? -1 : count;
        } catch (Exception e) {
            e.printStackTrace();
            return 0;
